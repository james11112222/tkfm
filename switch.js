    ...
    if (lightSwitch) {
      ...
      function darkMode() {
        ...
        if (isSelected) {
          ...
          if (document.getElementById('filtered')) document.getElementById('filtered').className = document.getElementById('filtered').className.replace(/-light/g, "-dark");
      ...
      function lightMode() {
        if (lightSwitch.checked) {
          ...
          if (document.getElementById('filtered')) document.getElementById('filtered').className = document.getElementById('filtered').className.replace(/-dark/g, "-light");
